...
SendStream.prototype.pipe = function(res, type){
  var self = this
    , args = arguments
    , path = this.path
    , root = this._root;
...
SendStream.prototype.send = function(path, stat, type){
  var options = {};
  var len = stat.size;
  var res = this.res;
  var req = this.req;
...
SendStream.prototype.type = function(path, type){
  var res = this.res;
  if (res.getHeader('Content-Type')) return;
  var type = type || mime.lookup(path);
