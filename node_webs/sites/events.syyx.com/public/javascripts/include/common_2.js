...
function rungame(){
    ...
    }else if(pagename == "index_sw" || pagename == "index_sw_embed" || pagename == "index_sw_1" || pagename == "index_sw_bt") {
    ...
    ok: function(info) {
        ...
        $("#active_link").click(function(event) {
            ...
            if(reg_account == "" || active_code == "" ){
                ...
                $.post('/activate_card', {account : reg_account , card : active_code}, function(data) {
                    $("#reg_step2").hide()
                    if(data == "0"){
                        $("#reg_step4").show()
                        $(".active_account").html(reg_account)
                    } else {                        
                        $("#active_tip").html("很抱歉，" + data + "！")
                        $("#reg_step5").show()
                        $("#back").click(function() {
                            $("#reg_step2").show()
                            $("#reg_step5").hide()
