...
getflash('http://r.syyx.com/events/p036/prize.swf', 284, 55, "#prize")
getjwplayer('http://v.nycs.syyx.com/nycs/flv/chuizhi_164x92_20120927.flv', 164, 92, "#flash", "none");
getflash('http://r.syyx.com/events/p036/flash_but.swf', 164, 92, "#flash_but")
...
function job_focus() {
        ...
        getflash('http://r.syyx.com/events/p036/flash_but.swf', 168, 98, "#flash_but_2")
...
$("#to_reg_3").click(function() {
    $("html").animate({ scrollTop: 530 }, "normal")
    $("body").animate({ scrollTop: 530 }, "normal")
