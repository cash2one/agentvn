...
getflash('http://r.syyx.com/events/p069/prize.swf', 250, 72, "#prize")
getjwplayer('http://v.nycs.syyx.com/nycs/flv/tibuflash_186x106_20120530.flv', 186, 105, "#flash", "none");
getflash('http://r.syyx.com/events/p069/flash_but.swf', 186, 105, "#flash_but")
...
function job_focus() {
        ...
        getflash('http://r.syyx.com/events/p052/flash_but.swf', 168, 98, "#flash_but_2")
...
$("#to_reg_3").click(function() {
    $("html").animate({ scrollTop: 500 }, "normal")
    $("body").animate({ scrollTop: 500 }, "normal")
