...
function getPlayerAllyList(){
    ...
    $('#tablePlayerAlly').datagrid({
        url: 'http://nysjdm.syyx.cn/gameanalyse/game_playerally_list?&StartDate=' + startDate + '&EndDate=' + endDate + '&ServerID=' + serverID + '&r=' + Math.random(),
        title: '战友召唤统计',
        width: 800,
        fitColumns: true,
        nowrap: false,
        ...
        columns: [[
            ...
            { field: 'CallNumber', title: '作为非队长被召唤的人数', width: 70, align: 'center' },
            { field: 'CalledNumber', title: '作为队长进行战友召唤的人数', width: 70, align: 'center' }
        ]]
    });
