...
function getMoneyLiftList(){
    ...
    $('#tableMoneyLift').datagrid({
             url: 'http://nysjdm.syyx.cn/gameanalyse/game_moneylift_list?StartDate=' + startDate + '&EndDate=' + endDate + '&ServerID=' + serverID + '&r=' + Math.random(),
             title: '金钱留存统计',
             width: 800,
             fitColumns: true,
             nowrap: false,
             ...
             columns: [[
                    ...
                    { field: 'SilverCoin', title: ' 银币(万)', width: 120, align: 'center' }
                ]]
    });
}
