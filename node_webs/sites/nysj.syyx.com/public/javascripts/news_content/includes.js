...
function support_ie6_position_fixed(fix_elements){
    ...
    $(window).scroll(function(){
        ...
        var scrolled_left  = $(window).scrollLeft()
        var max_scoll_top  = $('body').height() - $('#float_reg_panel').height()
        // var max_scoll_left = $('body').width() - $('#float_reg_panel').width()
        if (scrolled_top < max_scoll_top ) {
