$(document).ready(function(){
    ...
    $("#zhizuo_3").lightBox();
    $("#zhizuo_4").lightBox();
    $("#flash_full_screen").show()
    $(".container").hide()
    getflash('http://v.nycs.syyx.com/nycs/swf/TVC_1024X576_0924.swf', 1024, 768, "#flash_full_screen")
});
...
getflash('http://r.syyx.com/party/nycs/spokesman/flash_but.swf', 188, 104, "#flash_but")
...
getflash('http://r.syyx.com/party/nycs/spokesman/flash_but.swf', 250, 150, "#flash_but_sg")


$("#flash_btn_sg").click(function(event) {
    $(document.body).append('<div id="pop_flash_dialog_sg"><div id="pop_flash_sg"></div></div>')
