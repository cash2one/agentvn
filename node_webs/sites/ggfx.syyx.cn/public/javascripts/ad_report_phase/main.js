...
function get_list() {
    ...
    var istotal=$("input[name='rdtype1']:checked").val();
    var isschedule=$("input[name='rdtype2']:checked").val();

    $.ajax({
        url: "http://ggfx.syyx.cn/ad_phase?r="+Math.random(),
        type: "get",
        dataType: "json",
        data: { GameID:gameid, StartTime:starttime, EndTime:endtime, ClassID:classid, MediaID:mediaid, ADID:adid, ADWebNumber:adwebnumber, IsTotal:istotal, IsSchedule:isschedule},
...
function get_se_list(gameid, starttime, endtime, isschedule){
    $.ajax({
        url: "http://ggfx.syyx.cn/ad_phase_se?r="+Math.random(),
        type: "get",
        dataType: "json",
